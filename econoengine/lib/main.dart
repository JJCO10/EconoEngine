...
void main() async {
  ...
  await languageController.loadSelectedLanguage(); // Carga el idioma guardado
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      theme: theme,
      // Configuración crítica para la localización
      locale: languageController.currentLocale,
      localizationsDelegates: AppLocalizations.localizationsDelegates,
      supportedLocales: AppLocalizations.supportedLocales,
      // locale: languageController.currentLocale,
      // supportedLocales: languageController.availableLanguages.values.toList(),
      // localizationsDelegates: const [
      //   GlobalMaterialLocalizations.delegate,
      //   GlobalWidgetsLocalizations.delegate,
      //   GlobalCupertinoLocalizations.delegate,
      //   // AppLocalizations.delegate, // Descomenta cuando esté listo
      // ],
