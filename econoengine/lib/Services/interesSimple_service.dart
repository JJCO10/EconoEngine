class InteresSimpleService {
  ...
  String validarCampos({
    ...
    if (requeridos[0] && (vp == null || vp <= 0)) return 'invalidVP';
    if (requeridos[1] && (vf == null || vf <= 0)) return 'invalidVF';
    if (requeridos[2] && (i == null || i <= 0)) return 'invalidRate';
    if (requeridos[3] && (t == null || t <= 0)) return 'invalidTime';
    return '';
  }
}
