...
import '../services/encryption_service.dart'; // Servicio de encriptación
import '../services/secure_storage_service.dart'; // Servicio de almacenamiento seguro
...
class AuthController {
  ...
  Future<bool> registrarUsuario(String nombre, String tipoDocumento, String numeroDocumento, String telefono, String email, String contrasena) async {
    try {
      ...
      User usuario = User(
        ...
        telefono: telefono,
        email: email,
        contrasena: encryptedPassword, // Usar la contraseña encriptada
      );
  ...
  Future<bool> iniciarSesion(String numeroDocumento, String contrasena) async {
    try {
      ...
      final firebaseUser = await _authService.iniciarSesion(numeroDocumento, encryptedPassword);
